...
<body class="mb-48">
    <nav class="flex justify-between items-center mb-4">
        ...
        <ul class="flex space-x-6 mr-6 text-lg">
            @auth
                <li>
                    <span class="fonts-bold uppercase"></span>
                    Welcome {{ auth()->user()->name }}
                </li>
                <li>
                    <a href="/" class="hover:text-laravel"><i class="fa-solid fa-home"></i>
                        Home </a>
                </li>
                <li>
    ...
    <footer
        ...
        <p class="ml-2">Copyright &copy; 2024, All Rights reserved Dreamer Inc.</p>
